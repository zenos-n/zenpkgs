...
let
  ...
  checks = {
    ...
    systemProgramVersion =
      index.options.system.sub.programs.sub.zenlink.sub.enable.meta.zenosVersion == "1.0.0Na";
    ...
    syncthingChildProvenance =
      index.options.system.sub.syncthing.sub.enable.meta.upstream
      && index.options.system.sub.syncthing.sub.guiAddress.meta.upstream;
    ...
    legacyAliasProvenance =
      index.options.legacy.meta.upstream
      && index.options.legacy.sub.networking.sub.hostName.meta.upstream
